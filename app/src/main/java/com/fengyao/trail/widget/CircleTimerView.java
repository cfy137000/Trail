...
public class CircleTimerView extends View {
    ...
    private static final int DEFAULT_HIGHLIGHT_LINE_COLOR = 0xFFE00032;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        currentTime = (int) (MaxTime / (2 * Math.PI) * currentRadian * 60);
        // Assist lines
//        canvas.drawColor(Color.RED);
        ...
        canvas.drawText("1", cx, getMeasuredHeight() / 2 - radius + circleStorkeWidth / 2 + gapBetweenCircleAndLine + longerLineLength + gapBetweenNumberAndLine + getFontHeight(numberPaint), numberPaint);
        canvas.drawText("1/4", cx + radius - circleStorkeWidth / 2 - gapBetweenCircleAndLine - longerLineLength - textLength / 2 - gapBetweenNumberAndLine, cy + getFontHeight(numberPaint) / 2, numberPaint);
        canvas.drawText("1/2", cx, getMeasuredHeight() / 2 + radius - circleStorkeWidth / 2 - gapBetweenCircleAndLine - longerLineLength - gapBetweenNumberAndLine, numberPaint);
        canvas.drawText("3/4", getMeasuredHeight() / 2 - radius + circleStorkeWidth / 2 + gapBetweenCircleAndLine + longerLineLength + gapBetweenNumberAndLine + textLength / 2, cy + getFontHeight(numberPaint) / 2, numberPaint);
        // Circle button
        canvas.save();
        ...
        // Timer Text
        canvas.save();
        canvas.drawText("剩余时间", cx, cy + getFontHeight(timerNumberPaint) / 2 + gapBetweenTimerNumberAndText + getFontHeight(timerTextPaint) / 2, timerTextPaint);
        canvas.restore();
        super.onDraw(canvas);
    }
